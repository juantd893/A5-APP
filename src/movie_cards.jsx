...
function Card (className){
  ...
  const detalle_filt = detalle.map(infor =>
    <div>
      ...
      <p><span id="boton" onClick={ () =>  setMovie(infor.null) & setIsVisible(false)}  className="btn btn-primary back_btn">regresar</span></p>
    </div>
  );
...
<div className="Sinopsis_div" >
  ...
  <p>{detalle_filt}</p>
    ...
    <div className="cartelera_div"  style={{ visibility: isVisible ? "hidden" : "visible"  }} >
      
      <p className="cartelera_titu">Cartelera </p>
        ...
        {data.map((user) => (
          <div className="tarjeta">
            ...
            <div className="item">
              ...
              <p>
              <span id="boton" onClick={ () => setMovie(user.key_id) &  setIsVisible(true)} className="btn btn-primary sinopsis_btn">SINOPSIS</span>
              </p>
            </div>
